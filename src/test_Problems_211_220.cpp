...
TEST( Problem_211, Given_Case ) {
  ...
  std::vector<int> const indecies = indexOf( "abracadabra", "abr" );
  std::vector<int> const expected = { 0, 7 };
...
TEST( Problem_212, Given_Case ) {
  ...
  std::string const col1 = colLetter( 1 );
  std::string const col2 = colLetter( 27 );
...
TEST( Problem_212, Test_Case ) {
  std::string const col1 = colLetter( 2 );
  std::string const col2 = colLetter( 25 );
  std::string const col3 = colLetter( 26 );
  std::string const col4 = colLetter( 52 );
  std::string const col5 = colLetter( 53 );
...
TEST( Problem_213, Given_Case ) {
  ...
  std::vector<std::string> const ips      = generateIpAddresses( "2542540123" );
  std::vector<std::string> const expected = { "254.25.40.123", "254.254.0.123" };
...
TEST( Problem_214, Given_Case ) {
  ...
  int const length = longestOneRun( 156 );
...
TEST( Problem_215, Given_Case ) {
  ...
  */
  ...
  std::vector<int> const result   = bottomView( root );
  std::vector<int> const expected = { 0, 1, 3, 4, 8, 9 };
  EXPECT_EQ( result, expected );
}

// Problem 216
TEST( Problem_216, Given_Case ) {
  int const result = romanToInt( "XIV" );
  EXPECT_EQ( result, 14 );
}

// Problem 217
TEST( Problem_217, Given_Case ) {
  int const result1 = nextSparse( 21 );
  int const result2 = nextSparse( 22 );
...
TEST( Problem_220, Given_Case ) {
  int const result = max_profit_coin_game( { 10, 24, 5, 9 } );
